 ...
 * @LastEditTime : 2019-12-23 19:11:52
 * @LastEditors  : 席鹏昊
        ...
        <el-form ref="form" :model="form" label-width="80px" class="form">
          ...
          <div class="exam">
            ...
            <el-select v-model="form.region1" placeholder="周考一">
              <el-option
                ...
                :value="item1.exam_id"
                v-for="(item1,index) in getAllData"
                :key="index"
              ></el-option>
            </el-select>
          </div>
          ...
          <div class="hasclass">
            ...
            <el-select v-model="form.region2" placeholder="javaScript上">
              <el-option
                v-for="(item2,index) in getClass"
                :key="index"
                :label="item2.subject_text"
          ...
          <div class="classTyple">
            ...
            <el-select v-model="form.region3" placeholder="简答题">
              <el-option
                v-for="(item3,index) in getQuestionsType"
                :key="index"
                :label="item3.questions_type_text"
                :value="item3.questions_type_id"
              ></el-option>
            </el-select>
          </div>
        </el-form>
